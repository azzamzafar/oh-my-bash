...
alias python='/usr/bin/python3'             # python is python3
alias addchanged='git add $(git diff --name-only)'  #git add changed
alias addnew='git add $(git ls-files --others --exclude-standard)' # git add new
alias venv='/usr/bin/python3 -m venv'       #creating venv with system python
alias gitnew="git ls-files --others --exclude-standard"
